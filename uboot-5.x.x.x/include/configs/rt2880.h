...
#ifdef DUAL_IMAGE_SUPPORT
#define CFG_KERN2_ADDR		 CFG_KERN_ADDR + 0x4800000//(CFG_FLASH2_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE))
#endif
#endif
...
//#endif
#define CFG_KERN_SIZE     0x2800000 //(40M)MTD_KERN_PART_SIZE
